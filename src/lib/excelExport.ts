...
function saveExcelBlob(workbook: XLSX.WorkBook, filename: string) {
  try {
    ...
    console.error(
      "Direct blob export error, falling back to XLSX.writeFile:",
      err,
    );
...
export function exportInvoicesToExcel(
  invoices: Invoice[],
  filename = "HESICS_Invoices_Register.xlsx",
) {
...
export function exportQuotationsToExcel(
  quotations: Quotation[],
  filename = "HESICS_Quotations_Register.xlsx",
) {
...
export function exportAuditLogsToExcel(
  logs: AuditLogEntry[],
  filename = "HESICS_Audit_Logs.xlsx",
) {
...
export function exportMonthlyIncomeToExcel(
  incomes: IncomeEntry[],
  filename = "HESICS_Income_Report.xlsx",
) {
...
export function exportMonthlyExpenseToExcel(
  expenses: ExpenseEntry[],
  filename = "HESICS_Expense_Report.xlsx",
) {
