...
export const getUsers = (callerEmail?: string): User[] =>
  db.getUsers(callerEmail);
export const getUserById = (id: string): User | undefined => db.getUserById(id);
export const getUserByEmail = (email: string): User | undefined =>
  db.getUserByEmail(email);
export const addUser = (
  data: Omit<User, "id" | "org_id" | "created_at">,
): User => db.addUser(data);
...
export const addRole = (data: Omit<Role, "id" | "org_id">): Role =>
  db.addRole(data);
export { db };
