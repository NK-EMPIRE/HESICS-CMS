...
export const addInvoice = (
  data: Omit<Invoice, "id" | "org_id" | "created_at">,
): Invoice => db.addInvoice(data);
export const updateInvoice = (
  id: string,
  data: Partial<Invoice>,
): Invoice | undefined => db.updateInvoice(id, data);
...
export const addQuotation = (
  data: Omit<Quotation, "id" | "org_id" | "created_at">,
): Quotation => db.addQuotation(data);
export const updateQuotation = (
  id: string,
  data: Partial<Quotation>,
): Quotation | undefined => db.updateQuotation(id, data);
