...
export const addIncomeEntry = (
  data: Omit<IncomeEntry, "id" | "org_id" | "created_at">,
): IncomeEntry => db.addIncomeEntry(data);
...
export const addExpenseEntry = (
  data: Omit<ExpenseEntry, "id" | "org_id" | "created_at">,
): ExpenseEntry => db.addExpenseEntry(data);
export const deleteExpenseEntry = (id: string): void =>
