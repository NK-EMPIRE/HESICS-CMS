...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
      <div
        className={`w-full ${maxWidthClasses[maxWidth]} bg-[#202020] border border-[#2e2e2e] rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]`}
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#2a2a2a] bg-[#1a1a1a]">
          ...
          <button
            onClick={onClose}
            className="p-1 text-[#777777] hover:text-white hover:bg-[#282828] rounded transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
