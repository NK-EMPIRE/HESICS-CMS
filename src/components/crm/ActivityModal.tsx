...
const ACTIVITY_TYPE_OPTIONS: Option[] = [
  { value: 'call', label: 'Executive Phone Call', badge: 'Call', badgeColor: 'text-[#D4D4D8] bg-[#77727E]/15 border-[#77727E]/30' },
  { value: 'meeting', label: 'Video / In-Person Meeting', badge: 'Meeting', badgeColor: 'text-indigo-300 bg-indigo-950/40 border-indigo-800/50' },
  { value: 'email', label: 'Official Written Email', badge: 'Email', badgeColor: 'text-emerald-400 bg-emerald-950/40 border-emerald-800/50' },
  { value: 'dm', label: 'Direct Message / WhatsApp', badge: 'DM', badgeColor: 'text-amber-300 bg-amber-950/40 border-amber-800/50' },
  { value: 'task', label: 'Milestone Task Action', badge: 'Task', badgeColor: 'text-rose-400 bg-rose-950/40 border-rose-800/50' },
];
      ...
      <div className="bg-[#0D0D11] border border-[#22222B] rounded-3xl w-full max-w-2xl max-h-[92vh] overflow-y-auto p-8 space-y-6 shadow-2xl shadow-black/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#808090]">
                Record client communication milestones and schedule action follow-ups.
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-[#1A1A22]">
            ...
            <button type="submit" disabled={isSubmitting} className="hesics-btn-primary px-6">
