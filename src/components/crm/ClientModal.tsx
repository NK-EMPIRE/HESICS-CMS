...
export const ClientModal: React.FC<ClientModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-modal flex items-center justify-center p-4">
      <div className="bg-[#0D0D11] border border-[#22222B] rounded-3xl w-full max-w-3xl max-h-[92vh] overflow-y-auto p-8 pb-12 space-y-6 pb-28 shadow-2xl shadow-black/80">
        {/* Modal Header */}
